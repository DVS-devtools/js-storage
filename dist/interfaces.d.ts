...
export interface StorageInterface {
    ...
    getMultiple(keys?: string[], options?: StorageOptions): {
        [key: string]: any;
    };
    setMultiple(params: {
        [key: string]: any;
 ...
 */
export declare type AvailableStorages = 'localstorage' | 'cookie' | 'jsobject';
